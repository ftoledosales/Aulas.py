# codigo para contar as vogais do bloco de texto
# codigo deve desconsiderar letras maiúsculas/minúscilas
# texto pode ser colocado diretamente como string no codigo
...
for chave, valor  in vogais.items():
  print(f'Há {valor} letras {chave} no texto')
